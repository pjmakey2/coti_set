...
from db.uw_exchange import ex_query, ex_bulk_insert, ranking_group
...
@router.post('/ranking_group', response_class=UJSONResponse)
def ranking_group(rgc: GRRanking,db: Session = Depends(db_session)):
